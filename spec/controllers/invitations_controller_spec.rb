  ...
  describe 'POST create' do
    ...
    context "with invalid input" do
      ...
      it "should not send an email if name is not filled in" do
        set_current_user
        post :create, invitation: { recipient_name: nil, recipient_email: 'joe.doe@joe.com', message: 'Check this out!', inviter_id: current_user.id }
      ...
      it "should not send an email if email is not filled in" do
        set_current_user
        post :create, invitation: { recipient_name: "Joe Doe", recipient_email: nil, message: 'Check this out!', inviter_id: current_user.id }
        expect(ActionMailer::Base.deliveries).to be_empty 
      end
      ...
      it "should redirect to invitations_path"
